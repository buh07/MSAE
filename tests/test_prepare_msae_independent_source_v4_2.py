...
SCRIPT = Path(__file__).parents[1] / "scripts/prepare_msae_independent_source_v4_2.py"
...
def test_history_snapshot_ignores_regenerated_binary_but_binds_text_and_quarantine(tmp_path: Path, monkeypatch):
