...
SPEC=importlib.util.spec_from_file_location('tcm_r4_1',ROOT/'scripts/trained_copy_method_benchmark_v1_r4_1.py')
assert SPEC and SPEC.loader
tcm=importlib.util.module_from_spec(SPEC);sys.modules['tcm_r4_1']=tcm;SPEC.loader.exec_module(tcm)
...
def test_gpu_visibility_mismatch_fails_before_cuda(monkeypatch,tmp_path):
 monkeypatch.setenv('CUDA_VISIBLE_DEVICES','wrong');lock=tmp_path/'msae_trained_copy_methods_v1_r4_1_expected.lockdir';lock.mkdir();(lock/'token').write_text('x')
...
def test_r4_formal_namespace_is_preserved_and_r4_1_is_isolated():
 ...
 assert 'r4_1' in c['runtime']['output_root'] and 'r4_1' in c['runtime']['provenance_root']
