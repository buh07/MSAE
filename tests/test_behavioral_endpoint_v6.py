...
spec = importlib.util.spec_from_file_location("behavioral_endpoint_v6", ROOT / "scripts/behavioral_endpoint_v6.py")
v6 = importlib.util.module_from_spec(spec)
assert spec.loader is not None
spec.loader.exec_module(v6)
CFG = json.loads((ROOT / "configs/behavioral_endpoint_v6/run.json").read_text())
...
def test_no_training_or_representation_method_execution_path():
    text = (ROOT / "scripts/behavioral_endpoint_v6.py").read_text().lower()
