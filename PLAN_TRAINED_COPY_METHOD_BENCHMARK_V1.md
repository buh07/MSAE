# Trained-Copy Controller Method Benchmark v1
...
- Generate one fresh label-only controller-fit panel and disjoint development/confirmation panels
  using new frozen seeds. Use 64 blocks x 32 rows for fit and 24 blocks x 8 rows for each evaluation
...
- Make controller types prospectively component-disjoint, not merely row-ID-disjoint. Partition the
  ...
  query is counterbalanced independently of target, and every evaluation target appears six times
  while every query appears 24 times. Choose the sham from a different offset in the same panel pool;
...
- `python -m py_compile scripts/trained_copy_method_benchmark_v1.py`
- `pytest -q tests/test_trained_copy_method_benchmark_v1.py`
- `python scripts/trained_copy_method_benchmark_v1.py candidate-preflight --device cpu`
- `python scripts/trained_copy_method_benchmark_v1.py candidate-preflight --device cuda`
- `python scripts/trained_copy_method_benchmark_v1.py mutation-suite`
- `python scripts/trained_copy_method_benchmark_v1.py verify-freeze --opaque`
- `python scripts/trained_copy_method_benchmark_v1.py verify-review-binding`
- `bash -n scripts/launch_trained_copy_method_benchmark_v1_tmux.sh`
