# Trained-Copy Controller Method Benchmark v1 — Technical Successor R4
...
- `python -m py_compile scripts/trained_copy_method_benchmark_v1_r4.py`
- `pytest -q tests/test_trained_copy_method_benchmark_v1_r4.py`
- `python scripts/trained_copy_method_benchmark_v1_r4.py candidate-preflight --device cpu`
- `python scripts/trained_copy_method_benchmark_v1_r4.py candidate-preflight --device cuda`
- `python scripts/trained_copy_method_benchmark_v1_r4.py mutation-suite`
- `python scripts/trained_copy_method_benchmark_v1_r4.py verify-freeze --opaque`
- `python scripts/trained_copy_method_benchmark_v1_r4.py verify-review-binding`
- `bash -n scripts/launch_trained_copy_method_benchmark_v1_r4_tmux.sh`
...
## R4 adversarial repair addendum

R3 candidate `cfc94705...6f4` was blocked and preserved before generator lock or payload creation. R4 prospectively binds the test and launcher through every lineage gate, defines analytic fit-dependent parameter counts, expands all protocol semantics in the hashed method table, exercises the actual fitted rank-64 output oracle and rank ordering, and adds unpaired-selector and zero/permutation negative mutations.
