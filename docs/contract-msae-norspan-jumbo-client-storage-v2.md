# NORSPAN — Jumbo client storage contract v2
...
logs are linked in the v3plan; earlier green primitive/candidate evidence is preserved.
...
publication/verification/read boundaries. Scratch final held-directory name checks
