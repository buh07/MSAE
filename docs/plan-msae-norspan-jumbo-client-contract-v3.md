# PLAN — NORSPAN Jumbo client contract and integration v3
...
at OwnedPair.validate and after create's last existing check before transfer.
...
read-time scheduling. Injection must fire; retain every failed original root.
