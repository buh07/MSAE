# Trained-Copy Controller Method Benchmark v1 — Technical Successor R3
...
- `python -m py_compile scripts/trained_copy_method_benchmark_v1_r3.py`
- `pytest -q tests/test_trained_copy_method_benchmark_v1_r3.py`
- `python scripts/trained_copy_method_benchmark_v1_r3.py candidate-preflight --device cpu`
- `python scripts/trained_copy_method_benchmark_v1_r3.py candidate-preflight --device cuda`
- `python scripts/trained_copy_method_benchmark_v1_r3.py mutation-suite`
- `python scripts/trained_copy_method_benchmark_v1_r3.py verify-freeze --opaque`
- `python scripts/trained_copy_method_benchmark_v1_r3.py verify-review-binding`
- `bash -n scripts/launch_trained_copy_method_benchmark_v1_r3_tmux.sh`
