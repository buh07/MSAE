...
import msae_independent_measurement_v3_post_m2_gen9 as protocol
import msae_independent_measurement_v3_post_m2_gen9_runtime as runtime
...
def run(args: argparse.Namespace) -> None:
    ...
    expected_runner = local_entries["scripts/run_msae_independent_calibration_v3_gen9.py"]["sha256"]
