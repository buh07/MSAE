...
SESSION="transformer_realistic_bridge_v1_20260810r2"
BRIDGE_OUT="$ROOT/results/transformer_realistic_bridge_v1_20260810r2"
METHODS_OUT="$ROOT/results/transformer_realistic_methods_v1_20260810r2"
BRIDGE_PROV="$ROOT/reports/provenance/transformer_realistic_bridge_v1_run_20260810r2"
METHODS_PROV="$ROOT/reports/provenance/transformer_realistic_methods_v1_run_20260810r2"
SCRIPT="$ROOT/scripts/transformer_realistic_bridge_v1_r2.py"
...
MSAE_ROOT="$ROOT" python "$ROOT/scripts/verify_transformer_realistic_bridge_v1_r2_recovery.py" check-bound >/dev/null
...
set +e
MSAE_ROOT="\$RUN_ROOT" python "\$RUN_ROOT/scripts/transformer_realistic_bridge_v1_r2.py" run-pipeline --physical-index "$chosen_index" --gpu-uuid "$chosen_uuid" --launch-token "$launch_token" 2>&1 | tee "\$RUN_ROOT/reports/provenance/transformer_realistic_bridge_v1_run_20260810r2/launcher.log"
rc=\${PIPESTATUS[0]}
set -e
exit \$rc
EOF
