...
RUN="$ROOT/scripts/behavioral_endpoint_v6_1.py"
CONFIG="configs/behavioral_endpoint_v6_1/run.json"
FREEZE="configs/behavioral_endpoint_v6_1/FREEZE.json"
PREFIX="msae_behavior_v6_1"
OUT="results/behavioral_endpoint_v6_1_20260809"
PROV="reports/provenance/behavioral_endpoint_v6_1_run_20260809"
CANDIDATE_REVIEW="reports/adversarial/behavioral_endpoint_v6_1_candidate_review.md"
FROZEN_REVIEW="reports/adversarial/behavioral_endpoint_v6_1_frozen_review.md"
REVIEW_BINDING="reports/provenance/behavioral_endpoint_v6_1_candidate/FROZEN_REVIEW_BINDING.json"
...
sleep 2
"$PY" - "$PREFIX" "$PROV/launch_manifest.json" "$OUT" <<'PY'
import json,subprocess,sys
from pathlib import Path
prefix,manifest,out=sys.argv[1:];out=Path(out)
...
p['initial_clean_terminals']=clean
