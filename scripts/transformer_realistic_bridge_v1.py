...
BRIDGE_CONFIG = ROOT / "configs/transformer_realistic_bridge_v1/run.json"
METHODS_CONFIG = ROOT / "configs/transformer_realistic_methods_v1/run.json"
PLAN = ROOT / "PLAN_TRANSFORMER_REALISTIC_BRIDGE_V1.md"
REGIME_ORDER = (
    "ideal_hard",
    "soft_attention",
    "residual_bypass",
...
def candidate_paths(kind: str) -> list[Path]:
    common = [
        ...
        ROOT / "reports/adversarial/transformer_realistic_bridge_v1_plan_review.md",
        ROOT / "scripts/transformer_realistic_bridge_v1.py",
        ROOT / "scripts/launch_transformer_realistic_bridge_v1_tmux.sh",
        ROOT / "tests/test_transformer_realistic_bridge_v1.py",
    ]
    if kind == "bridge":
