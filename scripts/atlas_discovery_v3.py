...
NAMESPACE = "atlas_discovery_v3_1_attempt5"
DROP = "__DROP__"
...
def build_prepared_data(config: Mapping[str, Any], config_path: Path) -> dict[str, Any]:
    ...
    if str(config.get("data_root")) != "data/atlas_discovery_v3_1_attempt5":
    ...
    process_snapshot = {
        "schema_version": "atlas_discovery_v3_1_attempt5_process_snapshot_v1",
        "argv": sys.argv,
        "cwd": str(Path.cwd()),
    ...
    opened_input_ledger = {
        "schema_version": "atlas_discovery_v3_1_attempt5_opened_input_ledger_v1",
    ...
    manifest: dict[str, Any] = {
        "schema_version": "atlas_discovery_v3_1_attempt5_prepared_v1",
    ...
    preflight = {
        "schema_version": "atlas_discovery_v3_1_attempt5_preflight_v1",
