#!/usr/bin/env python3
"""Closed post-gen2 controller for the MSAE gen6 successor protocol."""
...
PLAN_REVIEW_PATH = ROOT / "reports/adversarial/msae_independent_measurement_v3_post_m2_gen6_plan.md"
...
def __getattr__(name: str) -> Any:
    raise AttributeError(f"gen6 controller does not expose legacy attribute: {name}")
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    from msae_independent_measurement_v3_post_m2_gen6_runtime import dispatch
    dispatch(raw)
