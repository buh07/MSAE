#!/usr/bin/env python3
"""Separate hooked/unhooked RoPE numerical diagnosis for Atlas attempt 8."""
...
def _diagnostic_conditions() -> tuple[list[dict[str, Any]], dict[str, Any]]:
    ...
    manifest = {"schema_version": "atlas_rope_v4_attempt8_diagnostic_population_v1",
...
def compare(signing_key: Path) -> dict[str, Any]:
    ...
    payload = {"schema_version": "atlas_rope_v4_attempt8_diagnostic_complete_v1", "status": "PASS",
