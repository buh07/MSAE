...
NAMESPACE = "atlas_discovery_v3_2_attempt6"
DROP = "__DROP__"
...
def build_prepared_data(config: Mapping[str, Any], config_path: Path) -> dict[str, Any]:
    ...
    if str(config.get("data_root")) != "data/atlas_discovery_v3_2_attempt6":
        raise RuntimeError("v3.1 attempt5 requires its fresh exact data namespace")
    ...
    process_snapshot = {
        "schema_version": "atlas_discovery_v3_2_attempt6_process_snapshot_v1",
        "argv": sys.argv,
        "cwd": str(Path.cwd()),
    ...
    if split_artifact.get("schema_version") != "atlas_discovery_v3_2_attempt6_population_split_v1":
    ...
    opened_input_ledger = {
        "schema_version": "atlas_discovery_v3_2_attempt6_opened_input_ledger_v1",
    ...
    manifest: dict[str, Any] = {
        "schema_version": "atlas_discovery_v3_2_attempt6_prepared_v1",
    ...
    preflight = {
        "schema_version": "atlas_discovery_v3_2_attempt6_preflight_v1",
