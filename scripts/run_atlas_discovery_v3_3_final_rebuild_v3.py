...
from atlas_discovery_v3_3_final_rebuild_v3 import build_prepared_data, sha256_file
...
def main() -> None:
    ...
    parser.add_argument("--config", default="configs/atlas_discovery_v3_3/run_final_v3_rebuild1.json")
