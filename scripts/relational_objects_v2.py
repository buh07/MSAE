#!/usr/bin/env python3
"""Deterministic contracts for the relational-objects v2 development study."""
...
CONFIG = ROOT / "configs/relational_objects_v2/run.json"
NAMESPACE = "relational_objects_v2_opened_development2"
