...
SCRIPT="${REPO_ROOT}/scripts/pcc_stage_a1b_audit.py"
RUN_TS="$(date +%Y%m%d_%H%M%S)"
RUN_ROOT="${REPO_ROOT}/pilot_runs/${RUN_TS}_pcc_stage_a1b"
...
launch_job() {
  ...
  local session="pcc-a1b-${job_id}-${RUN_TS}"
