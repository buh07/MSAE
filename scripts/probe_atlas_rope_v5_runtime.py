#!/usr/bin/env python3
"""No-weight/no-forward runtime probe for Atlas v3.5 attempt 9."""
...
from atlas_rope_v5 import ROOT, atomic_json, loaded_library_attestation, sha256_file
...
def probe(output: Path) -> dict[str, object]:
    ...
    payload: dict[str, object] = {
        "schema_version": "atlas_rope_v5_attempt9_runtime_probe_v1",
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=ROOT / "data/atlas_rope_v5_attempt9_runtime_probe.json")
