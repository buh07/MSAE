#!/usr/bin/env python3
"""Closed post-gen2 controller for the MSAE gen7 successor protocol."""
...
PLAN_PATH = ROOT / "docs/plan-msae-independent-measurement-v3-post-m7-gen7.md"
PLAN_REVIEW_PATH = ROOT / "reports/adversarial/msae_independent_measurement_v3_post_m2_gen7_plan.md"
...
def __getattr__(name: str) -> Any:
    raise AttributeError(f"gen7 controller does not expose legacy attribute: {name}")
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    from msae_independent_measurement_v3_post_m2_gen7_runtime import dispatch
    dispatch(raw)
