...
from atlas_discovery_v3_3_final_rebuild import build_prepared_data, sha256_file
...
def main() -> None:
    ...
    parser.add_argument("--config", default="configs/atlas_discovery_v3_3/run_final_rebuild1.json")
