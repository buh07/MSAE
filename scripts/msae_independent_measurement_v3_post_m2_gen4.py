#!/usr/bin/env python3
"""Closed post-gen2 controller for the MSAE gen4 successor protocol."""
...
SOURCE_ONLY_LOCAL_MODULES = frozenset({
    ...
    "run_msae_independent_calibration_v3_gen4",
})
...
PLAN_REVIEW_PATH = ROOT / "reports/adversarial/msae_independent_measurement_v3_post_m2_gen4_plan.md"
...
def __getattr__(name: str) -> Any:
    raise AttributeError(f"gen4 controller does not expose legacy attribute: {name}")
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    from msae_independent_measurement_v3_post_m2_gen4_runtime import dispatch
    dispatch(raw)
