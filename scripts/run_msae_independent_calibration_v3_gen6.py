...
import msae_independent_measurement_v3_post_m2_gen6 as protocol
import msae_independent_measurement_v3_post_m2_gen6_runtime as runtime
...
def run(args: argparse.Namespace) -> None:
    ...
    expected_runner = local_entries["scripts/run_msae_independent_calibration_v3_gen6.py"]["sha256"]
