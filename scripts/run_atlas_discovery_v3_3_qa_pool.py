...
from atlas_discovery_v3_3_qa_pool import build_prepared_data, sha256_file
...
def load_config(path: Path) -> dict[str, Any]:
    ...
    if config.get("schema_version") != "atlas_discovery_v3_3_attempt7_qa_pool_run_v1":
...
def main() -> None:
    ...
    parser.add_argument("--config", default="configs/atlas_discovery_v3_3/qa_pool.json")
