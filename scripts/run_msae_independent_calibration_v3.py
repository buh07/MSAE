...
import msae_independent_measurement_v3_post_m1 as protocol
import msae_independent_measurement_v3_post_m1_runtime as runtime
...
def run(args: argparse.Namespace) -> None:
    ...
    closure = protocol.read_json(protocol.V3_DATA / "dependency_closure.json")
    local_entries = {item["path"]: item for item in closure["entries"]}
    expected_runner = local_entries["scripts/run_msae_independent_calibration_v3.py"]["sha256"]
    ...
    readiness = {
        ...
        "dependency_closure_sha256": protocol.sha_file(protocol.V3_DATA / "dependency_closure.json"),
        "authorization_envelope_sha256": authorization["envelope_sha256"],
