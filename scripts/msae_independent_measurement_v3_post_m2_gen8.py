#!/usr/bin/env python3
"""Closed post-gen2 controller for the MSAE gen8 successor protocol."""
...
SOURCE_ONLY_LOCAL_MODULES = frozenset({
    ...
    "run_msae_independent_calibration_v3_gen8",
})
...
PLAN_PATH = ROOT / "docs/plan-msae-independent-measurement-v3-post-m8-gen8.md"
PLAN_REVIEW_PATH = ROOT / "reports/adversarial/msae_independent_measurement_v3_post_m2_gen8_plan.md"
...
def __getattr__(name: str) -> Any:
    raise AttributeError(f"gen8 controller does not expose legacy attribute: {name}")
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    from msae_independent_measurement_v3_post_m2_gen8_runtime import dispatch
    dispatch(raw)
