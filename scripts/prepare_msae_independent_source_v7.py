#!/usr/bin/env python3
"""Source-readiness builder for MSAE v7; standard-library and model-free."""
...
REPO = "https://github.com/UniversalDependencies/UD_Finnish-TDT.git"
RAW = ROOT / "data/msae_independent_source_v7/raw" / COMMIT
PRIVATE = ROOT / "data/msae_independent_source_v7/private"
PROV = ROOT / "reports/provenance/msae_independent_source_v7"
QUARANTINES = {
...
V7_PREFIX = "data/msae_independent_source_v7/"
V7_AUTHORITY = {
    "docs/plan-msae-independent-source-v7.md",
    "reports/adversarial/msae_independent_source_v7_plan_review.md",
    "reports/provenance/msae_independent_source_v7/preacquisition_alias_screen.json",
    "reports/provenance/msae_independent_source_v7/historical_source_registry.json",
    "reports/provenance/msae_independent_source_v7/preacquisition_authority_manifest.json",
    "reports/provenance/msae_independent_source_v7/baseline_inventory.json",
    ...
    "reports/verification/msae_independent_source_v7_source_free_checks.log",
    "reports/adversarial/msae_independent_source_v7_preacquisition_implementation_review.md",
    "reports/adversarial/msae_independent_source_v7_preacquisition_authority_review.md",
}
V7_FROZEN_AUTHORITY_SHA256 = {
    "docs/plan-msae-independent-source-v7.md":
        "67053a1b4a222de2fd9de18c534f2f5e58024413224e859c7ddfed4b63261916",
    "reports/adversarial/msae_independent_source_v7_plan_review.md":
        "3f8ceedbd4be7f3335b8675f1e241e7fd3193719bb4d0bc55a3df54fc19a9429",
    "reports/provenance/msae_independent_source_v7/preacquisition_alias_screen.json":
        "336a3a4082a1096201ae897715629aff870939d003fc9c6650de748ef16df3d7",
    "reports/provenance/msae_independent_source_v7/historical_source_registry.json":
        "a5edbe04ce5ca083aa16cc4cade9d64beffe4a0541d67cd7a42dc05e7ec6712f",
}
...
ALIAS_TOKEN_SEQUENCES = (("ud", "finnish", "tdt"), ("finnish", "tdt"), ("fi", "tdt"),
                         ("https", "github", "com", "universaldependencies", "ud", "finnish", "tdt", "git"),
                         (COMMIT,))
...
def scientific_artifact_inventory() -> dict[str, Any]:
    ...
    return {"schema_version":"msae_independent_source_v7_scientific_artifact_inventory_v1",
            "entries":entries}
...
def strict_json(path: Path) -> Any:
    ...
    # presentation; every builder-published v7 final uses canonical_file_bytes.
...
def verify_process_snapshot_schema(value: Any, code: str) -> None:
    ...
    if (value["schema_version"] != "msae_independent_source_v7_process_snapshot_v1"
...
def validate_acquisition_config(path: Path) -> dict[str, Any]:
    ...
    if (value.get("schema_version") != "msae_independent_source_v7_acquisition_v1"
...
def group_split_key(group_id: str, source_commit: str = COMMIT) -> str:
    ...
    return sha_bytes(canonical_bytes(
        ["msae-independent-source-v7/C1C2-group", source_commit, group_id]))
...
def build_split_manifest(rows: list[dict[str, Any]], dedup: dict[str, Any],
    ...
    split={"schema_version":"msae_independent_source_v7_split_manifest_v1","source_commit":COMMIT,
...
def payload_record(row: dict[str, Any]) -> dict[str, Any]:
    return {"schema_version":"msae_independent_source_v7_payload_v1","source_repo":REPO,
...
def public_label(task: str, value: str) -> str:
    if task == "token_identity": return sha_bytes(("msae-v7/token\0" + value).encode())
    if task == "lemma_identity": return sha_bytes(("msae-v7/lemma\0" + value).encode())
    return value
...
def _walk_paths() -> Iterator[tuple[Path, str]]:
    for base, dirs, files in os.walk(ROOT):
        ...
        for d in sorted(dirs):
            ...
            if child_rel.startswith(V7_PREFIX.rstrip("/")):
                if any(child.iterdir()):
                    raise GateFailure("preexisting_v7_namespace")
                continue
...
def inventory_repository() -> dict[str, Any]:
    ...
    for key in sorted(by_inode, key=lambda z: min(x[1] for x in by_inode[z])):
        ...
        for _p, rel, s in group:
            ...
            elif rel.startswith(V7_PREFIX): item.update(disposition="v7_excluded", adapter="excluded", extracted_unit_count=0)
            elif rel in V7_AUTHORITY:
                item.update(disposition="v7_authority", adapter="authority", extracted_unit_count=0)
            entries.append(item)
    ...
    return {"schema_version": "msae_independent_source_v7_baseline_inventory_v1",
            ...
            "authority_expected_absent": sorted(V7_AUTHORITY - {x["path"] for x in entries}),
...
def validate_history_registry_binding(inventory: dict[str, Any],
    ...
    if (registry.get("schema_version") != "msae_independent_source_v7_historical_source_registry_v1"
            ...
            or registry.get("domain_utf8") != "msae-v7/pedigree"
            ...
            or screen.get("schema_version") != "msae_independent_source_v7_preacquisition_alias_screen_v2"
...
def deduplicate_roles(roles: dict[str, list[Sentence]]) -> tuple[dict[str, list[Sentence]], dict[str, Any]]:
    ...
    report = {"schema_version": "msae_independent_source_v7_dedup_v1", "roles": {},
...
def _support(rows: dict[str, list[dict[str, Any]]]) -> dict[str, Any]:
    ...
    return {"schema_version":"msae_independent_source_v7_support_v1","floor_distinct_utterances":20,
...
def _license() -> dict[str,Any]:
    ...
    readme_result=license_evidence(read_text_nofollow(rp))
    ok=license_result["eligible"] and readme_result["eligible"]
    return {"schema_version":"msae_independent_source_v7_license_v1","license_id":"CC-BY-SA-4.0",
            "license_path":"LICENSE.txt","license_sha256":sha_file(lp),"readme_sha256":sha_file(rp),
            "license_url":"https://creativecommons.org/licenses/by-sa/4.0/",
            "evidence":{"LICENSE.txt":license_result,"README.md":readme_result},
            "obligations":["attribution","share_alike"],"raw_committed":False,"payload_committed":False,
            "contradiction_count":license_result["contradiction_count"]+readme_result["contradiction_count"],
...
def document_group_census() -> dict[str, Any]:
    ...
    return {"schema_version":"msae_independent_source_v7_document_group_census_v1",
...
def _source_family(inventory: dict[str,Any], raw_hashes:set[str]) -> dict[str,Any]:
    ...
    return {"schema_version":"msae_independent_source_v7_source_family_v1","status":"eligible" if eligible else "ineligible",
            "disposition":"project_source_use_unseen_before_v7","content_occurrence_count":len(matches),
...
def pedigree_hash(value: str) -> str:
    return sha_bytes(b"msae-v7/pedigree\0" + value.encode("utf-8"))
...
def candidate_pedigree() -> dict[str, Any]:
    ...
    identifiers = {normalize_pedigree(value.encode("utf-8")) for value in
                   (REPO, COMMIT, "UD_Finnish-TDT", "fi_tdt", *SOURCE_FILES.values())}
    for name in ("README.md", "LICENSE.txt"):
        ...
        if any(pattern.search(payload) for pattern in PEDIGREE_OVERBOUND):
            raise GateFailure("overbound_candidate_pedigree_whitespace")
        key_prefix = re.compile(rb'"' + PEDIGREE_KEYS + rb'"\s{0,256}:\s{0,256}"', re.I)
    ...
    return {"schema_version": "msae_independent_source_v7_candidate_pedigree_v1",
...
def verify_frozen_v7_authority_bindings() -> dict[str, str]:
    if any(sha_file(ROOT/path)!=digest for path,digest in V7_FROZEN_AUTHORITY_SHA256.items()):
        raise GateFailure("predecessor_drift")
    return dict(V7_FROZEN_AUTHORITY_SHA256)


def _verify_predecessor_and_raw() -> dict[str, Any]:
    expected = {ROOT/path:digest for path,digest in verify_frozen_v7_authority_bindings().items()}
    ...
    required_public=(
        ...
        ROOT/"reports/adversarial/msae_independent_source_v7_preacquisition_authority_review.md",
    ...
    config=validate_acquisition_config(ROOT/"configs/msae_independent_source_v7/acquisition.json")
    ...
    if (entry.get("schema_version")!="msae_independent_source_v7_source_acquisition_entry_v1"
            ...
            or entry.get("config_sha256")!=sha_file(ROOT/"configs/msae_independent_source_v7/acquisition.json")
            or entry.get("runner_sha256")!=sha_file(ROOT/"scripts/acquire_msae_independent_source_v7.py")
    ...
    if (acquisition.get("schema_version")!="msae_independent_source_v7_source_acquisition_v1"
            ...
            or acquisition.get("config_sha256") != sha_file(ROOT/"configs/msae_independent_source_v7/acquisition.json")
            ...
            or acquisition.get("runner_sha256") != sha_file(ROOT/"scripts/acquire_msae_independent_source_v7.py")
    ...
    expected_command_argv=[
        [*config["ignore_argv"][:-1],"data/msae_independent_source_v7/raw/sentinel"],
        [*config["ignore_argv"][:-1],"data/msae_independent_source_v7/private/sentinel"],
    ...
    if ([item.get("path") for item in ignores] != ["data/msae_independent_source_v7/raw/sentinel","data/msae_independent_source_v7/private/sentinel"]
...
def _verify_history_snapshot(inventory: dict[str, Any], allowed_added: set[str] | None = None,
    ...
    current_paths={rel for _path,rel in _walk_paths_allow_v7(include_v7=True)}
    ...
    for item in inventory["entries"]:
        if item["disposition"] not in {"text_scanned", "archive_scanned", "binary_unscanned", "v7_authority", "quarantine"}:
...
def _raw_history_additions() -> set[str]:
    return {f"data/msae_independent_source_v7/raw/{COMMIT}/{name}"
...
def _control_history_additions(*, success: bool = False) -> set[str]:
    additions={
        ...
        "reports/provenance/msae_independent_source_v7/preacquisition_authority_manifest.json",
        "reports/adversarial/msae_independent_source_v7_preacquisition_authority_review.md",
        "reports/provenance/msae_independent_source_v7/source_acquisition_entry.json",
    }
    if success:additions.add("reports/provenance/msae_independent_source_v7/source_acquisition.json")
    else:
        for name in ("source_acquisition.json","source_acquisition_rejection.json"):
            if present_path(PROV/name):additions.add(f"reports/provenance/msae_independent_source_v7/{name}")
    return additions


def _success_history_additions() -> set[str]:
    return (_control_history_additions(success=True)|_raw_history_additions()|
            {f"reports/provenance/msae_independent_source_v7/{name}"
             for name in SCIENTIFIC_ARTIFACT_NAMES}|
            {"data/msae_independent_source_v7/private/blind_payload.jsonl"})
...
def _rejection_history_additions(public_inventory: dict[str,Any],
    ...
    additions=_control_history_additions()|_raw_history_additions()|{
        "reports/provenance/msae_independent_source_v7/rejection.json"}
...
def verify_pre_payload_v7_namespace() -> None:
    fds=[]
    try:
        v7fd=open_repo_dir(RAW.parent.parent);fds.append(v7fd)
        rawrootfd=os.open("raw",os.O_RDONLY|getattr(os,"O_DIRECTORY",0)|getattr(os,"O_NOFOLLOW",0),dir_fd=v7fd);fds.append(rawrootfd)
        ...
        for fd,mode in ((v7fd,0o700),(rawrootfd,0o700),(commitfd,0o555)):
            if stat.S_IMODE(os.fstat(fd).st_mode)!=mode:raise GateFailure("v7_namespace_directory_drift")
        if sorted(os.listdir(v7fd)) != ["raw"]:raise GateFailure("v7_namespace_extra_path")
        if sorted(os.listdir(rawrootfd)) != [COMMIT]:raise GateFailure("v7_raw_parent_extra_path")
...
def process_snapshot() -> dict[str, Any]:
    ...
    for child in sorted(Path("/proc").iterdir(), key=lambda item: int(item.name) if item.name.isdigit() else -1):
        ...
        item={"pid":int(child.name),"start_ticks":stat_fields[19],"executable_basename":exe,
              "command_sha256":sha_bytes(b"msae-v7/process\0"+raw),"forbidden_codes":codes}
        entries.append(item)
        if codes:matches.append(item)
    return {"schema_version":"msae_independent_source_v7_process_snapshot_v1",
...
def verify_training_roots(inventory: dict[str, Any]) -> None:
    ...
    current=[]
    for path,rel in _walk_paths_allow_v7():
...
def _walk_paths_allow_v7(include_v7: bool = False) -> Iterator[tuple[Path,str]]:
    for base,dirs,files in os.walk(ROOT,followlinks=False):
        ...
        for d in sorted(dirs):
            ...
            if stat.S_ISLNK(st.st_mode) or not stat.S_ISDIR(st.st_mode):
                raise GateFailure("special_paths")
            if d=="__pycache__" or any((rel+"/").startswith(x) for x in GENERATED_PREFIXES) or (not include_v7 and rel.startswith(V7_PREFIX.rstrip("/"))):
                continue
            retained.append(d)
        dirs[:]=retained
        for name in sorted(files):
...
def implementation_review_sha() -> str:
    review=ROOT/"reports/adversarial/msae_independent_source_v7_preacquisition_implementation_review.md"
    required=[
        sha_file(ROOT/"docs/plan-msae-independent-source-v7.md"),
        sha_file(ROOT/"reports/adversarial/msae_independent_source_v7_plan_review.md"),
        sha_file(PROV/"preacquisition_alias_screen.json"),
        sha_file(PROV/"historical_source_registry.json"),
        sha_file(Path(__file__)),
        sha_file(ROOT/"scripts/acquire_msae_independent_source_v7.py"),
        sha_file(ROOT/"tests/test_prepare_msae_independent_source_v7.py"),
        sha_file(ROOT/"configs/msae_independent_source_v7/acquisition.json"),
        sha_file(ROOT/"reports/verification/msae_independent_source_v7_source_free_checks.log"),
    ]
...
def build_authority_manifest() -> None:
    ...
    authority_review=ROOT/"reports/adversarial/msae_independent_source_v7_preacquisition_authority_review.md"
    ...
    _verify_history_snapshot(
        baseline,
        allowed_added={"reports/provenance/msae_independent_source_v7/baseline_inventory.json"},
    )
    ...
    review_path=ROOT/"reports/adversarial/msae_independent_source_v7_preacquisition_implementation_review.md"
    _require_ship_review(review_path,[inputs["scripts/prepare_msae_independent_source_v7.py"],
                                      inputs["tests/test_prepare_msae_independent_source_v7.py"],
                                      inputs["configs/msae_independent_source_v7/acquisition.json"],
                                      inputs["reports/verification/msae_independent_source_v7_source_free_checks.log"]])
    ...
    value={"schema_version":"msae_independent_source_v7_preacquisition_authority_v1",
...
def verify_authority_chain() -> dict[str, Any]:
    ...
    if (manifest.get("schema_version")!="msae_independent_source_v7_preacquisition_authority_v1"
    ...
    review_path=ROOT/"reports/adversarial/msae_independent_source_v7_preacquisition_authority_review.md"
...
def build_baseline() -> None:
    ...
    validate_acquisition_config(ROOT/"configs/msae_independent_source_v7/acquisition.json")
...
def build_ready() -> None:
    ...
    verify_pre_payload_v7_namespace()
    ...
    _verify_history_snapshot(
        ...
        allowed_added=raw_additions|{
            ...
            "reports/adversarial/msae_independent_source_v7_preacquisition_authority_review.md",
            "reports/provenance/msae_independent_source_v7/source_acquisition_entry.json",
            "reports/provenance/msae_independent_source_v7/source_acquisition.json",
        },
    )
    ...
    source_manifest={"schema_version":"msae_independent_source_v7_source_manifest_v1","source_commit":COMMIT,
    ...
    cross=_role_overlap(rows);write_json(PROV/"cross_role_overlap.json",{"schema_version":"msae_independent_source_v7_cross_role_overlap_v1","blocking_collision_count":len(cross),"blocking_collisions":cross,"status":"eligible" if not cross else "ineligible"})
    ...
    role_manifest={"schema_version":"msae_independent_source_v7_role_manifest_v1","source_commit":COMMIT,"roles":{}}
    ...
    plan_sha=sha_file(ROOT/"docs/plan-msae-independent-source-v7.md");review_sha=sha_file(ROOT/"reports/adversarial/msae_independent_source_v7_plan_review.md")
    seal={"schema_version":"msae_independent_source_v7_seal_v1","status":"independent_source_ready_for_future_prescore_protocol","source_status":"project_source_use_unseen_before_v7","plan_sha256":plan_sha,"plan_review_sha256":review_sha,"program_sha256":sha_file(Path(__file__)),"acquisition_runner_sha256":sha_file(ROOT/'scripts/acquire_msae_independent_source_v7.py'),"test_sha256":sha_file(ROOT/'tests/test_prepare_msae_independent_source_v7.py'),"artifact_sha256":bindings,"payload":{"path":"data/msae_independent_source_v7/private/blind_payload.jsonl","sha256":sha_file(payload),"size":ps.st_size,"record_count":len(test_rows),"mode":stat.S_IMODE(ps.st_mode),"nlink":ps.st_nlink},"model_operations_initiated_by_builder":0,"gpu_queries_initiated_by_builder":0,"training_runs_initiated_by_builder":0,"external_observation_scope":"baseline_and_terminal_proc_snapshots_plus_training_root_diff","unsupported_tasks":["neutral_prefix_offset","entity_binary","entity_type","source_genre"],"opaque_binary_history_excluded":True,"document_speaker_cluster_inference_authorized":False}
    seal_sha=sha_bytes(canonical_file_bytes(seal))
    write_json(PROV/"no_training_gate.json",{"schema_version":"msae_independent_source_v7_no_training_gate_v1","status":"pending_terminal_seal","terminal_status_if_seal_matches":"independent_source_ready_for_future_prescore_protocol","model_scoring_authorized":False,"k2_or_branch_training_authorized":False,"stage_c_authorized":False,"seal_sha256":seal_sha})
...
def retain_rejection(code: str) -> None:
    ...
    history_registry_status="unavailable";history_inputs_sha256=None
    ...
    if present_path(PROV/"baseline_inventory.json"):
        try:
            ...
            training_status="changed";history_registry_status="changed"
        else:
            try:
                verify_training_roots(baseline);training_status="unchanged"
            except (GateFailure,OSError):training_status="changed"
            try:
                history_inputs_sha256=validate_history_registry_binding(baseline)
                _verify_history_snapshot(baseline,_rejection_history_additions(public_inventory,private_state))
                history_registry_status="unchanged"
            except (GateFailure,OSError):history_registry_status="changed"
    ...
    value={"schema_version":"msae_independent_source_v7_rejection_v1","status":"rejected","failure_code":code,
           ...
           "training_root_status":training_status,"history_registry_status":history_registry_status,
           "history_inputs_sha256":history_inputs_sha256,"model_scoring_authorized":False,
...
def _validate_inventory_artifact(value: Any, code: str) -> None:
    exact_keys(value,{"schema_version","baseline_head","entry_count","counts","quarantine_content_reads",
        ...
        "training_root_entries","training_root_entries_sha256","history_inputs_sha256"},code)
    entries=value["entries"]
    if not isinstance(entries,list) or any(not isinstance(item,dict) for item in entries):raise GateFailure(code)
    ...
    for item in entries:
        ...
        if (keys!=expected or not isinstance(item.get("path"),str)
                ...
                or item.get("disposition") not in {"text_scanned","archive_scanned","binary_unscanned","v7_authority","quarantine"}
    ...
    if (value["schema_version"]!="msae_independent_source_v7_baseline_inventory_v1"
...
def validate_scientific_artifacts() -> None:
    ...
    if (census["schema_version"]!="msae_independent_source_v7_document_group_census_v1"
    ...
    if (source["schema_version"]!="msae_independent_source_v7_source_manifest_v1"
    ...
    if set(license_value["evidence"])!={"LICENSE.txt","README.md"}:raise GateFailure(code)
    for evidence in license_value["evidence"].values():
        ...
        if (evidence["eligible"] is not True
            ...
            raise GateFailure(code)
    if (license_value["schema_version"]!="msae_independent_source_v7_license_v1"
    ...
    if (family["schema_version"]!="msae_independent_source_v7_source_family_v1" or family["status"]!="eligible"
            or family["disposition"]!="project_source_use_unseen_before_v7"
    ...
    if (pedigree["schema_version"]!="msae_independent_source_v7_candidate_pedigree_v1"
    ...
    if (dedup["schema_version"]!="msae_independent_source_v7_dedup_v1"
    ...
    if (cross["schema_version"]!="msae_independent_source_v7_cross_role_overlap_v1"
    ...
    if (overlap["schema_version"]!="msae_independent_source_v7_history_overlap_v1"
    ...
    if (support["schema_version"]!="msae_independent_source_v7_support_v1" or support["floor_distinct_utterances"]!=20
...
def reconstruct_scientific_artifacts() -> dict[str, Any]:
    ...
    roles,source_counts=_all_source()
    source={"schema_version":"msae_independent_source_v7_source_manifest_v1","source_commit":COMMIT,
            "partitions":source_counts,"source_text_published":False}
    ...
    cross_value={"schema_version":"msae_independent_source_v7_cross_role_overlap_v1",
...
def verify_terminal() -> None:
    ...
    if (present_path(seal_path.with_name("."+seal_path.name+".building"))
            or present_path(rejection_path.with_name("."+rejection_path.name+".building"))):
    ...
    if present_path(rejection_path):
        rejection=strict_terminal_json(rejection_path)
        exact_keys(rejection,{"schema_version","status","failure_code","scientific_artifact_inventory",
            ...
            "history_registry_status","history_inputs_sha256",
        ...
        expected_payload=({key:final_state[key] for key in ("path","sha256","size","mode","nlink")}
                          if payload_created else None)
        current_inventory=scientific_artifact_inventory()
        if rejection.get("scientific_artifact_inventory")!=current_inventory:
        ...
        history_status="unavailable";history_digest=None;training_status="unavailable"
        if present_path(PROV/"baseline_inventory.json"):
            try:baseline=strict_json(PROV/"baseline_inventory.json")
            except (GateFailure,OSError):
                history_status="changed";training_status="changed"
            else:
                try:
                    history_digest=validate_history_registry_binding(baseline)
                    _verify_history_snapshot(
                        baseline,_rejection_history_additions(current_inventory,current_payload_state))
                    history_status="unchanged"
                except (GateFailure,OSError):history_status="changed"
                try:
                    verify_training_roots(baseline);training_status="unchanged"
                except (GateFailure,OSError):training_status="changed"
        if (rejection.get("schema_version")!="msae_independent_source_v7_rejection_v1"
                ...
                or rejection.get("training_root_status")!=training_status
                or rejection.get("history_registry_status")!=history_status
                or rejection.get("history_inputs_sha256")!=history_digest
    ...
    if (seal.get("schema_version")!="msae_independent_source_v7_seal_v1"
            or seal.get("status")!="independent_source_ready_for_future_prescore_protocol"
            or seal.get("source_status")!="project_source_use_unseen_before_v7"
            or seal.get("plan_sha256")!=sha_file(ROOT/"docs/plan-msae-independent-source-v7.md")
            or seal.get("plan_review_sha256")!=sha_file(ROOT/"reports/adversarial/msae_independent_source_v7_plan_review.md")
            or seal.get("program_sha256")!=sha_file(Path(__file__))
            or seal.get("acquisition_runner_sha256")!=sha_file(ROOT/"scripts/acquire_msae_independent_source_v7.py")
            or seal.get("test_sha256")!=sha_file(ROOT/"tests/test_prepare_msae_independent_source_v7.py")
    ...
    _verify_predecessor_and_raw()
    baseline=strict_json(PROV/"baseline_inventory.json")
    _validate_inventory_artifact(baseline,"seal_history_closure")
    validate_history_registry_binding(baseline)
    _verify_history_snapshot(baseline,_success_history_additions())
    verify_training_roots(baseline)
    expected_artifacts={
    ...
    expected_schemas={
        "baseline_inventory.json":"msae_independent_source_v7_baseline_inventory_v1",
        "source_acquisition_entry.json":"msae_independent_source_v7_source_acquisition_entry_v1",
        "source_acquisition.json":"msae_independent_source_v7_source_acquisition_v1",
        "source_family.json":"msae_independent_source_v7_source_family_v1",
        "candidate_pedigree.json":"msae_independent_source_v7_candidate_pedigree_v1",
        "license.json":"msae_independent_source_v7_license_v1",
        "document_group_census.json":"msae_independent_source_v7_document_group_census_v1",
        "source_manifest.json":"msae_independent_source_v7_source_manifest_v1",
        "dedup.json":"msae_independent_source_v7_dedup_v1",
        "history_manifest.json":"msae_independent_source_v7_baseline_inventory_v1",
        "history_overlap.json":"msae_independent_source_v7_history_overlap_v1",
        "cross_role_overlap.json":"msae_independent_source_v7_cross_role_overlap_v1",
        "support.json":"msae_independent_source_v7_support_v1",
        "role_manifest.json":"msae_independent_source_v7_role_manifest_v1",
        "split_manifest.json":"msae_independent_source_v7_split_manifest_v1",
        "post_process_snapshot.json":"msae_independent_source_v7_process_snapshot_v1",
        "preacquisition_alias_screen.json":"msae_independent_source_v7_preacquisition_alias_screen_v2",
        "historical_source_registry.json":"msae_independent_source_v7_historical_source_registry_v1",
        "preacquisition_authority_manifest.json":"msae_independent_source_v7_preacquisition_authority_v1",
    }
    ...
    if (any(not isinstance(item,dict) or set(item)!={"sent_id","panel","group_rank","within_group_rank",
            ...
            or split.get("schema_version")!="msae_independent_source_v7_split_manifest_v1"
    ...
    if (roles.get("schema_version")!="msae_independent_source_v7_role_manifest_v1"
    ...
    if (gate.get("schema_version")!="msae_independent_source_v7_no_training_gate_v1"
