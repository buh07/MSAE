...
def build_prepared_data(config: Mapping[str, Any], config_path: Path) -> dict[str, Any]:
    ...
    if str(config.get("data_root")) != "data/atlas_discovery_v3_3_attempt7_final_v2_rebuild1":
    ...
    if split_artifact.get("schema_version") != "atlas_discovery_v3_3_attempt7_population_split_v2":
