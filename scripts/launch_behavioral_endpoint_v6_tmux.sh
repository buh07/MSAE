...
RUN="$ROOT/scripts/behavioral_endpoint_v6.py"
CONFIG="configs/behavioral_endpoint_v6/run.json"
FREEZE="configs/behavioral_endpoint_v6/FREEZE.json"
PREFIX="msae_behavior_v6"
OUT="results/behavioral_endpoint_v6_20260809"
PROV="reports/provenance/behavioral_endpoint_v6_run_20260809"
CANDIDATE_REVIEW="reports/adversarial/behavioral_endpoint_v6_candidate_review.md"
FROZEN_REVIEW="reports/adversarial/behavioral_endpoint_v6_frozen_review.md"
REVIEW_BINDING="reports/provenance/behavioral_endpoint_v6_candidate/FROZEN_REVIEW_BINDING.json"
